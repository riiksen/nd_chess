...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Nd Chess web application."
  #
  #
  ...
  #
  # settings.secret_key_base= TBeXJWbVjKYVq4i_HuasLjdGRuHFpJ6P1TvOQpDW3Co
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("nd_chess.log", "w"))
  #
  #
end
